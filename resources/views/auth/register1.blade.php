    ...
    <div id="pwa" class="container pt-lg-5">
        <div class="row">
            <div class="col-lg-4 text-center my-3">
                <img src="{{ \App\Model\Setting::first()->app_icon }}" style="width: 64%;margin: auto;border-radius:500px;" alt="">

                {{-- <img src="{{ \App\Model\Setting::first()->icon_site }}" style="width: 80%;margin: auto;border-radius:500px;" alt="{{ \App\Model\Setting::first()->title }}"> --}}
            </div>
            <div class="col text-secondary mt-3">
                <h4 class="mb-4 text-center">نصب ورژن PWA اپلیکیشن {{ \App\Model\Setting::first()->title }}</h4>
                ...
                <a href="{{route('user.index')}}" class="btn btn-sm btn-danger col-12 d-none d-lg-block" >فهمیدم</a>
            </div> 
        </div>
    </div>
    <footer class="footer mt-auto py-3 text-center d-lg-none" style="bottom: 0px;width: 100%;">
        <div class="container">
            <a href="{{route('user.index')}}" class="btn btn-sm btn-danger col-12" >فهمیدم</a>
        </div>
    </footer>
