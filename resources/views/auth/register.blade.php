                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide text-center pb-3">
                        <div class="image-circle">
                            <figure class="background" style="border: 6px solid #dee2e6">
                                <img src="{{ \App\Model\Setting::first()->app_icon?url(\App\Model\Setting::first()->app_icon):'' }}" alt="{{ \App\Model\Setting::first()->title }}">
                            </figure>
                        </div>
                        <h4 class="mt-0 my-3">{{ \App\Model\Setting::first()->title }}</h4>
                        <div class="text-center">
                            <p class="small-font text-secondary">برای ادامه روی دکمه ها کلیک کنید</p>
                        </div>
                    </div>
                </div>
            </div>
