                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body box-profile">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 mt-2 mb-2">
                                    <label for="exampleInputFile">آیکون اپلیکیشن(png)</label>
                                    <div class="input-group">
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input" id="exampleInputFile" name="app_icon" accept=".png">
                                            <label class="custom-file-label" dir="ltr" for="exampleInputFile">انتخاب فایل</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6 mt-2">
                                    @if(is_file($item->app_icon))
                                        <img src="{{url($item->app_icon)}}" class="mt-4" width="50">
                                    @endif
                                </div>
                            </div>
                            <div class="row my-3">
