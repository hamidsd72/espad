...
@section('content')
    ...
    <div class="col-12 m-lg-4">
        <div class="card p-4">
            <form action="{{ route('admin.job-opportunities.store') }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                <div class="row" id="fa" role="tabpanel" aria-labelledby="farsi-tab">
                    ...
                    @if ( $type=='موقعیت' )
                        <div class="col-lg-6 form-group">
                            ...
                            <select id="sub_cat_id" name="sub_cat_id" class="form-control select2">
                                @foreach ( \App\Model\JobOpportunity::where('sub_cat_id','==',0)->get(['id','title']) as $key => $item)
                    ...
                    @if ( $type=='موقعیت' )
                        <div class="col-lg-6 form-group">
                            ...
                            <input type="text" class="form-control" id="history" name="history"  value="{{ old('history') }}"  required/>
                        </div>
                        <div class="col-lg-6 form-group">
                        ...
                        <div class="col-lg-12 form-group">
                            ...
                            <textarea class="form-control textarea " id="description" name="description" required>{{ old('description') }}</textarea>
                        </div>
                        <div class="col-lg-6 form-group">
