                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body box-profile">
                            {{ Form::open(array('route' => 'admin.sub_service.store', 'method' => 'POST', 'files' => true)) }}
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select id="group_id" name="group_id" class="form-control select2">
                                            @foreach (\App\Model\Group::all() as $cnt => $group)
                                                <option value="{{$group->id}}" @if($cnt==0) selected @endif >{{$group->title}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
