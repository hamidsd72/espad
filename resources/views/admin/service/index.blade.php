                        ...
                        <div class="card res_table">
                            <div class="card-header">
                                ...
                                @if (auth()->user()->getRoleNames()->first()=='مدیر')
                                    <div class="text-left">
                                        ...
                                        <a href="{{route('admin.service.create')}}" class="btn btn-secondary">
                                            ایجاد پکیج جدید
                                        </a>
                            ...
                            <div class="card-body res_table_in pt-0">
                                <table id="example2" class="table table-bordered table-hover">
                                    ...
                                    <tr>
                                        <td>@item($item->category()->service_id?\App\Model\ServiceCat::find($item->category()->service_id)->title:'______')</td>
                                        <td>@item($item->category()?$item->category()->title:'______')</td>
                                        <td>@item($item->title)</td>
                                        {{-- <td>@item($item->service_type)</td> --}}
                                        <td>@item($item->user()?$item->user()->first_name.' '.$item->user()->last_name:'______')</td>
