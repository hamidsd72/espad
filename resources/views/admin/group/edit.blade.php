    ...
    <section class="content">
        <div class="card card-primary card-outline">
            <div class="card-body box-profile">
                <form action="{{ route('admin.group.update',$item->id) }}" method="post" enctype="multipart/form-data" >
                    @csrf
                    @method('PATCH')
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group">
                                ...
                                {{ Form::text('slug',$item->slug, array('class' => 'form-control', 'required' => 'required')) }}
                            </div>
                        </div>
