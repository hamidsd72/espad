                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body box-profile">
                            ...
                            <div class="row">
                                <div class="col-lg">
                                    <div class="form-group">
                                        ...
                                        <select id="status" name="status" onchange="changeInput()" class="form-control">
                                            <option value="in_app">اسلابدر اپلیکیشن</option>
                                            <option value="in_home">اسلابدر صفحه اصلی</option>
                                            <option value="in_all">همه صفحات</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg">
                                ...
                                <div id="description" class="col-12 d-none">
                                    <div class="form-group">
                                ...
                                <div class="col-12"></div>
                                <div id="link_title" class="col-lg d-none">
                                    <div class="form-group">
