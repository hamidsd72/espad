    ...
    <section class="container">
        <div class="card res_table" style="background: transparent;">
            <div class="card-header">
                ...
                <a href="javascript:void(0);" data-toggle="modal" data-target="#ModalTicket" class="float-left btn btn-info">ادامه مشاوره</a>
            </div>
            <div class="row mb-0">
                @if($item->answered == "yes")
                    <div class="col p-0"></div>
                @endif
                <div class="col-11 col-lg-8 p-0 radius20 bg-white card-body res_table_in m-2 p-3 redu20">
