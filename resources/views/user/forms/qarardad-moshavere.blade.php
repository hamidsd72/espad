<div class="modal fade" id="qarardad-moshavere" tabindex="-1" aria-labelledby="qarardad-moshavereLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <form action="{{ route('user.forms.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="qarardad-moshavereLabel"></h5>
                </div>
                <div class="modal-body">
                    <input type="hidden" name="item_id" id="qarardad-id">
                    <input type="hidden" name="type" id="qarardad-type">
                    <input type="hidden" name="cons_id" id="qarardad-cons-id">
                    <input type="hidden" name="title" id="qarardad-title">
