...
Route::get('sub_service/filter/{id}', 'SubServiceController@index')->name('sub_service.filter');
...
Route::get('delete/sub-item/{id}', 'SubItemController@destroy')->name('item.delete');
