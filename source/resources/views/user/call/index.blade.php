...
<script type="text/javascript">
    ...
    navigator.mediaDevices.getUserMedia({
        ...
        localStream = stream;
        try {
            ws = new EventSource('https://spadstock.com/file_call/serverGet.php?unique='+unique+'&unique_url='+unique_url);
        } catch(e) {
        ...
        ws.send = function send(message) {
            ...
            xhttp.open('POST', 'https://spadstock.com/file_call/serverPost.php?unique='+unique+'&unique_url='+unique_url, true);
