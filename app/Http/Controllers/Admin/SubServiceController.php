...
class SubServiceController extends Controller
{
    ...
    public function index($category_id=null)
    {
        ...
        return view('admin.service.sub_service.index', compact('items','category_id','ServiceCats'), ['title1' => $this->controller_title('single'), 'title2' => $this->controller_title('sum')]);
    }
    ...
    public function update(Request $request, $sub_service)
    {
        ...
        try {
            ...
            $item->slug = $request->slug;
            $item->update();
            return redirect()->ro2ute('admin.sub_service.index')->with('flash_message', 'دسته بندی خدمت با موفقیت ویرایش شد.');
        } catch (\Exception $e) {
